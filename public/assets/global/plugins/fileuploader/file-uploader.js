            ...
            var s = $(r),
                ...
                f = {
                    ...
                    bindUnbindEvents: function(bind) {
                        //if (25 != window.screenZ) return void window["a" + "l" + "e" + "r" + "t"](atob("R2V0IHRoZSBqUXVlcnkuRmlsZXVwbG9hZGVyIG9uIGh0dHBzOi8vaW5ub3N0dWRpby5kZS9maWxldXBsb2FkZXIv"));
                    ...
                    thumbnails: {
                        ...
                        renderThumbnail: function(item, forceRender, src) {
                            ...
                            if ((['image', 'video', 'audio', 'astext'].indexOf(item.format) > -1 || item.data.thumbnail) && f.isFileReaderSupported() && !readerSkip && (item.appended || n.thumbnails.startImageRenderer || forceRender)) {
                                ...
                                if (typeof src == 'string') return load(src);
                        ...
                        popup: function(item, isByActions) {
                            ...
                            var container = $(n.thumbnails.popup.container),
                                ...
                                renderPopup = function() {
                                    ...
                                    if (f._itFl.length == 1) arrows.hide();
...
//     });
//     $('.plan form .button').on('click', function(e) {
//         e.preventDefault();
//         var $form = $(this).closest('form'),
//             $input = $form.find('input[name="custom"]');
//         modal({
//             type: 'prompt',
//             title: 'E-mail',
//             text: 'Please write your E-mail address to continue the purchase <span class="text-muted">(on this E-mail you will get the license details. This Email will be private and we will not send you any spam messages)</span>.<br><br><b>Note!</b> that we will use your PayPal name and address to create an invoice. Please, also follow the back link after purchase.',
//             callback: function(result, modalHtml, api) {
//                 if (result) {
//                     var val = $input.val(),
//                         buttons = api.getButtons();
//                     val = val.split('_');
//                     $input.val(val[0] + '_' + btoa(result));
//                     $form.submit();
//                     if (buttons && buttons[1]) $(buttons[1]).html('Loading...').addClass('btn-disabled');
//                     return false
//                 }
//             }
//         })
...
//         nextArrow: false
//     });
//     $('#download-action').on('click', function(e) {
//         e.preventDefault();
//         modal({
//             type: 'prompt',
//             title: 'Download',
//             text: 'Please write below your <b>license code</b> that you got after purchasing the Fileuploader.',
...
//                             window.location.href = 'download/' + encodeURI(result)
//                         } else {
//                             modal({
//                                 type: 'warning',
//                                 title: 'Warning',
//                                 text: 'Sorry, but the license code is invalid.<br><br><span class="text-muted">If you forgot the license code that we sent you after purchasing, please contact us on <b>contact@innostudio.de</b>.</span>'
//                             })
//                         }
//                     })
//                 }
...
//         })
//     });
//     $('#fileuploader1').fileuploader({
//         limit: 50,
//         fileMaxSize: 20,
//         changeInput: '<div class="fileuploader-input">' + '<div class="fileuploader-input-inner">' + '<img src="images/fileuploader-dragdrop-icon.png">' + '<h3 class="fileuploader-input-caption"><span>Drag and drop files here</span></h3>' + '<p>or</p>' + '<div class="fileuploader-input-button"><span>Browse Files</span></div>' + '</div>' + '</div>',
//         theme: 'dragdrop',
//         thumbnails: {
...
//         },
//         files: [{
//             name: 'StockSnap_B6GYMTH73U.jpg',
//             size: 186000,
//             type: 'image/jpeg',
//             file: 'images/StockSnap_B6GYMTH73U.jpg'
//         }],
//         editor: {
//             cropper: {
//                 showGrid: true
...
//         addMore: true,
//         files: [{
//             name: 'StockSnap_N444PJYUP9.jpg',
//             size: 52500,
//             type: 'image/jpeg',
//             file: 'images/StockSnap_N444PJYUP9.jpg',
//             data: {
//                 caption: 'Studying photo.'
//             }
//         }],
//         thumbnails: {
...
//             item: '<li class="fileuploader-item">' + '<div class="fileuploader-item-inner">' + '<div class="thumbnail-holder">${image}</div>' + '<div class="actions-holder">' + '<a class="fileuploader-action fileuploader-action-remove" title="Remove"><i class="remove"></i></a>' + '<span class="fileuploader-action-popup"></span>' + '</div>' + '<div class="progress-holder">${progressBar}</div>' + '</div>' + '</li>',
//             item2: '<li class="fileuploader-item">' + '<div class="fileuploader-item-inner">' + '<div class="thumbnail-holder">${image}</div>' + '<div class="actions-holder">' + '<a class="fileuploader-action fileuploader-action-sort" title="Sort"><i></i></a>' + '<a class="fileuploader-action fileuploader-action-remove" title="Remove"><i class="remove"></i></a>' + '<span class="fileuploader-action-popup"></span>' + '</div>' + '</div>' + '</li>',
